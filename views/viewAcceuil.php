					...
					<nav class="navbar navbar-expand-lg navbar-light navigation">
						...
						<div class="collapse navbar-collapse" id="navbarSupportedContent">
							<ul class="navbar-nav ml-auto main-nav ">
								<li class="nav-item">
									<a class="nav-link login-button" href="Login">Connexion</a>
								</li>
								<li class="nav-item">
						...
						<div class="col-sm-12 col-lg-4">
							...
							<div class="product-item bg-light">
								<div class="card">
									...
									<div class="card-body">
										<h4 class="card-title"><a>Festival du Roi Arthur</a></h4>
						...
						<div class="col-sm-12 col-lg-4">
							...
							<div class="product-item bg-light">
								<div class="card">
									...
									<div class="card-body">
										<h4 class="card-title"><a>Festivals des Vieilles Charrues</a></h4>
										<ul class="list-inline product-meta">
											<li class="list-inline-item">
						...
						<div class="col-sm-12 col-lg-4">
							...
							<div class="product-item bg-light">
								<div class="card">
									...
									<div class="card-body">
										<h4 class="card-title"><a>Festival Solidays</a></h4>
										<ul class="list-inline product-meta">
											<li class="list-inline-item">
						...
						<div class="col-sm-12 col-lg-4">
							...
							<div class="product-item bg-light">
								<div class="card">
									...
									<div class="card-body">
										<h4 class="card-title"><a>Festival Lolla Palooza</a></h4>
										<ul class="list-inline product-meta">
											<li class="list-inline-item">
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
	...
	$_SESSION['v_nbplace'] = intval($v_nbplace);
